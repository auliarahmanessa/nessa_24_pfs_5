...
window.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.chart, .budget');
    ...
    // Run the function on scroll and when page loads
    window.addEventListener('scroll', animateOnScroll);
    animateOnScroll(); // Trigger the function on page load
});
